...
#2004
total_house_nep2004 <- DropNA(nep2004, "GAY", message = TRUE)
total_house_nep2004 <- DropNA(total_house_nep2004, "HOU04", message = TRUE)
total_house_nep2004 <- subset(total_house_nep2004, HOU04!=0)
...
lgb_poc_house_nep2004 <- subset(lgb_house_nep2004, RACE!=1)
lgb_poc_house_nep2004_result <- round(prop.table(table(lgb_poc_house_nep2004$HOU04)),3)
straight_poc_house_nep2004 <- subset(straight_house_nep2004, RACE!=1)
...
#2006
total_house_nep2006 <- DropNA(nep2006, "GAY", message = TRUE)
total_house_nep2006 <- DropNA(total_house_nep2006, "HOU", message = TRUE)
...
#2008
total_house_nep2008 <- DropNA(nep2008, "GAY", message = TRUE)
total_house_nep2008 <- DropNA(total_house_nep2008, "HOUUS08", message = TRUE)
...
#2010
total_house_nep2010 <- DropNA(nep2010, "GAY", message = TRUE)
total_house_nep2010 <- DropNA(total_house_nep2010, "HOU", message = TRUE)
...
#2012
total_house_nep2012 <- DropNA(nep2012, "GAY", message = TRUE)
total_house_nep2012 <- DropNA(total_house_nep2012, "HOU", message = TRUE)
...
#2014
total_house_nep2014 <- DropNA(nep2014, "GAY", message = TRUE)
total_house_nep2014 <- DropNA(total_house_nep2014, "HOU", message = TRUE)
...
#2016
total_house_nep2016 <- DropNA(nep2016, "LGBT", message = TRUE)
total_house_nep2016 <- DropNA(total_house_nep2016, "HOU", message = TRUE)
...
#2018
total_house_nep2018 <- DropNA(nep2018, "LGBT", message = TRUE)
total_house_nep2018 <- DropNA(total_house_nep2018, "HOU", message = TRUE)
